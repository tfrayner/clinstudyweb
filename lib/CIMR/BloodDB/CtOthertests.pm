use utf8;
package CIMR::BloodDB::CtOthertests;
...
=head1 TABLE: C<ct_othertests>

=cut

__PACKAGE__->table("ct_othertests");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:APaxniZdr5LqBO6mc4yhXQ
