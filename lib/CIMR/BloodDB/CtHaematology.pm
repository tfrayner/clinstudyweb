use utf8;
package CIMR::BloodDB::CtHaematology;
...
=head1 TABLE: C<ct_haematology>

=cut

__PACKAGE__->table("ct_haematology");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ex6q8EioQOfM/j1onVAu7w
