...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{CLINSTUDY_WEB_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{CLINSTUDY_WEB_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
clinstudy_web_server.pl - Catalyst Testserver

=head1 SYNOPSIS

clinstudy_web_server.pl [options]
