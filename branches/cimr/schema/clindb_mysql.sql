...
CREATE TABLE `adverse_event` (
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY (`patient_id`,`type`,`start_date`),
  KEY (`patient_id`),
  KEY (`severity_id`),
  KEY (`action_id`),
  KEY (`outcome_id`),
...
CREATE TABLE `disease_event` (
  ...
  `notes` text,
  PRIMARY KEY  (`id`),
  UNIQUE KEY (`patient_id`,`type_id`,`start_date`),
  KEY (`type_id`),
  KEY (`patient_id`),
...
CREATE TABLE `prior_observation` (
  ...
  `date` date default NULL,
  PRIMARY KEY  (`id`),
  UNIQUE KEY (`patient_id`,`type_id`,`date`),
  KEY (`type_id`),
  KEY (`patient_id`),
...
CREATE TABLE `transplant` (
  ...
  `delayed_graft_function_id` int(11) default NULL,
  ...
  CONSTRAINT `transplant_ibfk_6` FOREIGN KEY (`delayed_graft_function_id`) REFERENCES `controlled_vocab` (`id`),
